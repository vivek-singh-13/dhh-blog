...
export default function TopBar() {
    ...
    return (
        <div className="top">
            ...
            <Link to="https://www.linkedin.com/in/viveksingh1312/" target="_blank" rel="noopener noreferrer" className="link"><LinkedInIcon className="topIcon"/></Link>
                <Link to="https://github.com/vivek-singh-13" target="_blank" rel="noopener noreferrer" className="link"><GitHubIcon className="topIcon"/></Link>
                <Link to="https://www.instagram.com/_viveksingh13/?hl=en" target="_blank" rel="noopener noreferrer" className="link"><InstagramIcon className="topIcon"/></Link>
